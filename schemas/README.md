...
`story-event/v1` tipizza eventi, causalità ed effetti; `continuity-state/v1` tipizza stato iniziale e snapshot derivati. I vincoli tra documenti, il reducer e il confronto degli snapshot restano in `scripts/studio.mjs`.
